package com.wind.common.utils.rsa;
...
public class RSACoder {
	...
	private static final String SIGNATURE_ALGORRITHM = "SHA1withRSA";// 数字签名 签名/验证算法
	
	private static final String PUBLIC_KEY = "RSAPublicKey";// 公钥变量名
	
	private static final String PRIVATE_KEY = "RSAPrivateKey";// 私钥变量名
	
	private static final int KEY_SIZE = 1024;// RSA密钥长度,默认为1024,密钥长度必须是64的倍数,范围在512~65526位之间
	...
	/**
	 * 生成密钥，公钥：RSAPublicKey 密码：RSAPrivateKey
	 * 
	 * @return 密钥Map
