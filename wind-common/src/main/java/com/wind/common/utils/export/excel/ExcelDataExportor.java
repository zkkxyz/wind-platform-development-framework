package com.wind.common.utils.export.excel;


import com.wind.common.utils.export.DataExportor;
import com.wind.common.utils.export.DataField;
import com.wind.common.utils.export.DataPage;
import com.wind.common.utils.export.ExportDataSource;


import com.wind.common.utils.export.csv.CsvDataExportor;
import com.wind.common.utils.string.StringTools;
import jxl.Workbook;
...
public class ExcelDataExportor<T> extends DataExportor<T> {
	...
	public void export() throws IOException {
		if (mode == null || mode == MODE.CSV) {//mode为null时导出纯文本，csv多分隔
