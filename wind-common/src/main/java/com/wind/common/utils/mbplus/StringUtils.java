...
public abstract class StringUtils {
     ...
     * @param name String
     * @param split String
     * @return String com.teamall.ispp.ne --> ne
     */
     ...
     * @return Integer
     */
    public static Integer randomMath(){
    	 Integer randomPass = (int)((Math.random()*9+1)*100000);//生成随机6位数作为初始密码
         return randomPass;
    }
     ...
     * @return
     */
    public static String randomMath2(){
