...
public final class Utils {
    ...
    /**
     * 判读该DECIMAL是否是整数，不包含小数
     * @param decimal
     * @return
     */
    public static boolean judgeDecimalIsInt(BigDecimal decimal){
    	if(decimal.compareTo(new BigDecimal(decimal.intValue()))!=0){//该金额包含小数
			return false;
		}
    	return true;
    }
     ...
     * @return
     */
    public static String formatDecimalToStr(BigDecimal decimal){
     ...
     * @return
     */
    public static String formatDecimalToStr2(BigDecimal decimal){
